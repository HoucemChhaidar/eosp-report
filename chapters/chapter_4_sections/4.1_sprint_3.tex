...
This diagram (see figure \ref{fig:seq_distribute_credit_to_admin}) models the bulk credit distribution process from Super Admin to Admin after cash payment at ASM:
...
The Super Admin credit distribution interface enables Super Admins to allocate credit to Admins after they provide cash payment at ASM.

\begin{figure}[H]
  \centering
  \fbox{\parbox{\textwidth}{\centering\vspace{3cm}[Super Admin Credit Distribution Interface Screenshot Placeholder]\\\vspace{0.5cm}This will show the Admin selection dropdown, credit amount input field,\\balance validation display, and distribution confirmation with real-time balance updates.\vspace{3cm}}}
  \caption{Super Admin Credit Distribution Interface}
