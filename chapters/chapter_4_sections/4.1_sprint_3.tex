...
\begin{table}[!htbp]
  \centering
  \small
  \caption{Sprint 3 Backlog – Credit Management} 
  ...
  \begin{tabular}{|p{1cm}|p{4cm}|p{7cm}|p{2cm}|}
    ...
    US7         & Bulk Credit Distribution to Admin After Cash Payment & As a Super Admin, I want to distribute bulk credit to an Admin after they provide cash at ASM to enable their organizational payment capabilities. & High            \\ \hline
    US8         & Distribute Credit Across End Users       & As an Admin, I want to distribute received credit across end users to enable their payment capabilities. & Critical         \\ \hline
  \end{tabular}
\end{table}
...
\subsubsection{Bulk Credit Distribution to Admin After Cash Payment}

\begin{longtable}{|p{0.2\textwidth}|p{0.75\textwidth}|}
  \caption{Description of use case "Bulk Credit Distribution to Admin After Cash Payment"}
  \label{tab:uc_distribute_bulk_credit_admin} \\
  \hline
  \textbf{Title} & Bulk Credit Distribution to Admin After Cash Payment \\ \hline
...
\subsubsection{Distribute Credit Across End Users}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.9\textwidth]{images/web_super_admin_credit}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.9\textwidth]{images/web_distribute_credit_end_users}
  \caption{Credit Distribution Dashboard - Admin to End Users Distribution}
