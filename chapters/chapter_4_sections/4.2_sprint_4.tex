...
\begin{table}[!htbp]
  ...
  \begin{tabular}{|p{1cm}|p{5cm}|p{6cm}|p{2cm}|}
    ...
    US10 & View Comprehensive Analytics Dashboard & As an Admin, I want to view comprehensive analytics to understand transaction patterns and credit usage across my organization. & Critical \\ \hline
  \end{tabular}
\end{table}
...
\subsubsection{View Comprehensive Analytics Dashboard}

\begin{longtable}{|p{0.2\textwidth}|p{0.75\textwidth}|}
  \caption{Description of use case "View Comprehensive Analytics Dashboard"}
  \label{tab:uc_view_analytics} \\
  \hline
  \textbf{Title} & View Comprehensive Analytics Dashboard \\ \hline
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.9\textwidth]{images/google_drive_artifacts}
...
\begin{figure}[H]
  ...
  \begin{subfigure}[b]{0.9\textwidth}
    \centering
    \includegraphics[width=\textwidth]{images/web_dashboard_1}
    \caption{Transaction Overview and Statistics}
    \label{fig:sprint4_analytics_dashboard_1}
  \end{subfigure}
  ...
  \begin{subfigure}[b]{0.9\textwidth}
    \centering
    \includegraphics[width=\textwidth]{images/web_dashboard_2}
    \caption{Detailed Charts and Trend Analysis}
    \label{fig:sprint4_analytics_dashboard_2}
  \end{subfigure}
  
  \caption{Admin Analytics Dashboard - Comprehensive View}
