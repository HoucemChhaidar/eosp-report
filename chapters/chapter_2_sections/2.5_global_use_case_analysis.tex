...
\textbf{SUPER\_ADMIN Actor:} Represents the top-level system administrators who oversee the entire Credix platform. This actor manages ADMIN accounts, distributes bulk credits to ADMINs, monitors system-wide activity, and maintains overall platform governance and operational oversight.
...
\textbf{USER Actor:} Represents individual employees or beneficiaries who utilize the Credix mobile application for daily payment transactions. This actor focuses on transactional capabilities, account management, and real-time payment processing functionalities.
...
\textbf{Sprint 1 (Purple):} Establishes foundational user management capabilities, enabling ADMIN actors to create, update, delete, and view users within the system. This sprint includes comprehensive wallet management functionality, providing the administrative foundation necessary for subsequent payment operations.

\textbf{Sprint 2 (Blue):} Implements core user transactional capabilities, including balance viewing, transaction history access, time-bound barcode generation for secure payments, and real-time transaction confirmation systems. This sprint delivers the essential payment functionality that users require for daily operations.

\textbf{Sprint 3 (Orange):} Focuses on advanced credit management operations, enabling ADMIN actors to purchase bulk credit, distribute credit across users, and monitor user transactions. This sprint addresses the sophisticated financial management requirements of admin clients.
