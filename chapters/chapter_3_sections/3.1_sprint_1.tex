...
The user management interface allows Admins to create, update, delete, and view end user accounts.

\begin{figure}[H]
  \centering
  \includegraphics[width=0.9\textwidth]{images/web_users_list}
  \caption{User Management Interface - Admin View}
...
\item User status monitoring and account activation controls
